...
`,
  ...
  readme: (config: { projectName: string; genre: string; complexity: string; useNewInputSystem: boolean }) => `# ${config.projectName} - Pro World

Generated by **Unity Project Architect Pro v5.0**.
...
${config.complexity === 'Enterprise' || config.complexity === 'UltimatePro' ? '- **Enterprise Patterns**: Service Locator, Object Pooling, Save System.\n- **Audio Management**: Integrated AudioManager singleton.' : ''}
...
namespace ${namespace}.EditorTools
{
    ...
    public class ProToolsEditor : Editor
    {
        ...
        {
            EditorGUILayout.HelpBox("Ultimate Pro Architect Active", MessageType.Info);
