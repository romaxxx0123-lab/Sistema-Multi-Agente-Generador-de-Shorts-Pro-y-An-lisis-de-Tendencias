...
`,
  ...
  readme: (config: any) => `# ${config.projectName} - Pro World

Generated by **Unity Project Architect Pro v4.0**.
...
${config.complexity === 'Enterprise' ? '- **ItemDatabase**: ScriptableObject data container.\n- **HighQualitySettings**: Universal Render Pipeline asset.' : ''}
...
${config.complexity === 'Enterprise' ? '- **Enterprise Patterns**: Service Locator, Object Pooling, Save System.\n- **Audio Management**: Integrated AudioManager singleton.' : ''}
