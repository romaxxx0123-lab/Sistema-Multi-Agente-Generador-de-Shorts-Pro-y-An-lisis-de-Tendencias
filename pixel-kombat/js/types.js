...
const TICONS = {
  ...
  motor: { pal: { r: '#c0392b', l: '#f2f2ef', d: '#2a2f3d', y: '#f5c542' },
    rows: ['.......', '..rrr..', '.rrrrr.', 'yrrrrry', 'rrrrrrr', '.d...d.', '.......'] },
...
const TYPES = {
  ...
  motor:     { name: 'MOTOR',     color: '#c0392b', tag: 'SE VA DEL MEET DE COSTADO' },
...
const CHART = {
  dinero:    { strong: ['algoritmo', 'motor', 'ritmo'], weak: ['futbol', 'oleo', 'motosierra'] },
  cohete:    { strong: ['ego', 'roca'],                  weak: ['oleo', 'futbol', 'ciencia', 'arquero'] },
  futbol:    { strong: ['dinero', 'ego', 'cohete'],      weak: ['roca', 'algoritmo', 'arquero'] },
  ego:       { strong: ['motor', 'algoritmo', 'arquero'], weak: ['cohete', 'futbol', 'ritmo', 'megafono'] },
  motor:    { strong: ['oleo', 'algoritmo', 'ritmo'],   weak: ['dinero', 'ego', 'roca'] },
  oleo:      { strong: ['dinero', 'cohete', 'roca', 'motosierra'], weak: ['motor', 'algoritmo'] },
  roca:      { strong: ['motor', 'futbol', 'ciencia', 'motosierra', 'megafono'], weak: ['cohete', 'oleo', 'algoritmo'] },
  algoritmo: { strong: ['futbol', 'oleo', 'roca'],       weak: ['dinero', 'ego', 'motor', 'ciencia', 'motosierra', 'megafono'] },
  ritmo:     { strong: ['ego', 'ciencia'],               weak: ['dinero', 'motor'] },
...
const REASONS = {
  ...
  'ego>motor':        'SE SACÓ UNA FOTO Y LO ECLIPSÓ',
  'ego>algoritmo':    'NINGÚN ALGORITMO LO ENTIENDE',
  'motor>oleo':       'PASÓ POR ENCIMA DEL CUADRO',
  'motor>algoritmo':  'UN CARBURADOR NO SE HACKEA',
  'oleo>dinero':      'EL ARTE NO SE PAGA EN CASH',
  'oleo>cohete':      'LE PINTÓ UNA NUBECITA',
  'oleo>roca':        'LE PINTÓ UN BIGOTE',
  'roca>motor':       'LEVANTÓ EL COCHE ENTERO',
...
const RESIST = {
  ...
  motor:      'ESO LO ESQUIVÓ EN SEGUNDA',
