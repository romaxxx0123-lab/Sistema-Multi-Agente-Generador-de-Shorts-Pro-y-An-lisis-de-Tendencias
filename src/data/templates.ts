...
namespace ${namespace}.EditorTools
{
  ...
  readme: (config: { projectName: string; genre: string; complexity: string; useNewInputSystem: boolean }) => `# ${config.projectName} - Aetheris Aeterna

Generated by **Unity World Architect v9.0 - Aetheris Engine**.
...
- **Aetheris Initializer**: Custom Editor Window for rapid project setup.
...
${config.complexity === 'NexusPrime' || config.complexity === 'Aetheris' ? '- **VFX Graph & Shaders**: Advanced HLSL and Visual Effect assets.' : ''}
